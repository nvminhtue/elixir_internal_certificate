defmodule ElixirInternalCertificateWeb.HealthPlugTest do
  use ElixirInternalCertificateWeb.ConnCase, async: true

  import ExUnit.CaptureLog

  alias ElixirInternalCertificateWeb.HealthPlug
  ...
  describe "call/2" do
    ...
    test "given the database is not ready, returns 500 internal server error " do
      expect(Ecto.Adapters.SQL, :query, fn ElixirInternalCertificate.Repo, "SELECT 1" ->
