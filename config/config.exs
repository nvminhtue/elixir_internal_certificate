...
config :elixir_internal_certificate,
  ecto_repos: [ElixirInternalCertificate.Repo]
...
config :elixir_internal_certificate, ElixirInternalCertificateWeb.Endpoint,
  ...
  url: [host: "localhost"],
  render_errors: [
    view: ElixirInternalCertificateWeb.ErrorView,
    accepts: ~w(html json),
    layout: false
  ],
  pubsub_server: ElixirInternalCertificate.PubSub,
  live_view: [signing_salt: "Yd24JO8J"]
...
config :elixir_internal_certificate, ElixirInternalCertificate.Mailer,
